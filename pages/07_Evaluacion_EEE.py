...
if not informe:
    ...
    with c1:
        st.metric("Explícitud", eee["expl"], "0–1")
    with c2:
        st.metric("Evidencia", eee["evid"], "0–3")
    with c3:
        st.metric("Examen", eee["exam"], "0–1")
    with c4:
        st.metric("EEE total", eee["eee"], "0–3")

    st.session_state["eee"] = eee
    st.caption("Heurística de demo. En producción: rúbrica validada y fiabilidad interevaluador.")
